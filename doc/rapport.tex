...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{diagClass/diagCalsse(1)-Page-24.drawio.pdf}
    \label{Figure 8}
\end{figure}
...
Lorsque le joueur veut créer un compte, il va remplir les champs obligatoires (nom d'utilisateur, mot de passe) qui sont montrés par la fenêtre (window). après que le joueur envoie les informations, le controlleur va vérifier si tous les champs sont remplis et si le joueur a bien saisi le nom d'utilisateurs et le mot de passe qui respectent le format général imposé par le système. Ensuite si les données sont valides, le serveur va faire une deuxième vérification qui concerne l'existence du compte, si le compte n'est pas déjà disponible sur la base de donnée (Data), les données vont être enregistrées.
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{PDFsequence/creation d'un compte.pdf}
    \label{Figure 9}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{PDFsequence/connexion.pdf}
    \label{Figure 10}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{PDFsequence/modeEndless.pdf}
    \label{Figure 11}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.6\textwidth]{PDFsequence/modeClassicEtDuel.pdf}
    \label{Figure 12}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{PDFsequence/modeRoyalCompetition.pdf}
    \label{Figure 13}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{PDFsequence/chat.pdf}
    \label{Figure 14}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.7\textwidth]{diagramme_srd/Creation_d'une_partie.pdf}
    \label{Figure 15}
\end{figure}
\newpage
\subsubsection{L'envoie des malus - mode Classic et Duel}
...
\begin{figure}[H]
    \centering
    \caption{Diagramme d'activité - malus mode Classic}
    \includegraphics[width=0.8\textwidth]{diagramme_srd/malus_classic.pdf}
    \label{Figure 16}
\end{figure}
\newpage
\subsubsection{L'envoie des malus - mode Royale}
...
\begin{figure}[H]
    ...
    \includegraphics[width=0.8\textwidth]{diagramme_srd/malus_royale.pdf}
    \label{Figure 17}
\end{figure}
