...
class Chat{
    ...
    public:
        ...
        std::string getMsgBetweenUsers(const std::string &user, const std::string& Friend);
        ...
        std::pair<std::string, std::string> getSenderReceiverId(const std::string& sender, const std::string& receiver);

        QueryResult getUserId(const std::string &username) const;
