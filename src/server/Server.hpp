...
public:
    ...
    void sendGameToPlayer(int clientSocket, int clientId, std::shared_ptr<Game> game, Score& score, std::shared_ptr<GameRoom> gameRoom);
    ...
    int getRandomTarget(int clientId);
    void handleMalusOrBonus(int clientId);
